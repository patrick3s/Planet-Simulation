...
def main():
    ...
    earth = Planet(-1 * Planet.AU , 0,16,BLUE, 5.9742 * 10**24,name='Terra')
    earth.y_vel = 29.783 * 1000
    mars = Planet(-1.524 * Planet.AU, 0,12,RED, 6.39 * 10 **23,name='Marte')
    mars.y_vel = 24.077 * 1000
    mercury = Planet(0.387 * Planet.AU, 0,8,DARK_GREY,3.30 * 10**24,name='Mercurio')
